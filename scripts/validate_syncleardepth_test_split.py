...
R=pathlib.Path('/home/liuke/xuxin/depth_io_inspection').resolve();o=R/'data/syncleardepth/test_split'; ids=(o/'test_ids.txt').read_text().splitlines() if (o/'test_ids.txt').exists() else []; rows=[{'sample_id':x,'status':'not_downloaded'} for x in ids]
